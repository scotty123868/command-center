...
const nbFinancialKpis = {
  ...
  scoreSparkline: [63, 65, 67, 70, 73, 77, 79, 82, 84, 87, 89, 91],
...
const brReceitaKpis = {
  totalSavings: 1_400_000_000,
  techScoreBefore: 55,
  techScoreAfter: 88,
  workflowsAnalyzed: 64,
  automationReady: 28,
  unusedLicenseWaste: 420_000_000,
  savingsSparkline: [0, 90_000_000, 200_000_000, 330_000_000, 500_000_000, 670_000_000, 800_000_000, 940_000_000, 1_070_000_000, 1_200_000_000, 1_310_000_000, 1_400_000_000],
  scoreSparkline: [55, 59, 62, 65, 68, 72, 75, 78, 81, 84, 86, 88],
  workflowSparkline: [0, 5, 10, 16, 22, 30, 38, 44, 50, 56, 60, 64],
  licenseSparkline: [420_000_000, 385_000_000, 350_000_000, 310_000_000, 270_000_000, 230_000_000, 190_000_000, 150_000_000, 120_000_000, 95_000_000, 75_000_000, 60_000_000],
...
const brReceitaTopOpportunities: Opportunity[] = [
  { name: 'Automated Tax Return Processing (35M Returns)', category: 'Tax Automation', savings: 480_000_000, effort: 'Medium', status: 'in-progress', priority: 10, timeToValue: 8, confidence: 94 },
  { name: 'ICMS/PIS/COFINS Cross-State Reconciliation', category: 'Tax Compliance', savings: 320_000_000, effort: 'High', status: 'in-progress', priority: 9, timeToValue: 12, confidence: 88 },
  { name: 'Federal Budget Optimization Analytics', category: 'Budget Analytics', savings: 210_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 10, confidence: 86 },
  { name: 'AI-Powered Risk-Based Audit Selection', category: 'Tax Audit', savings: 160_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 14, confidence: 82 },
  { name: 'Revenue Forecasting AI', category: 'Fiscal Planning', savings: 120_000_000, effort: 'Low', status: 'identified', priority: 7, timeToValue: 8, confidence: 84 },
  { name: 'Anti-Fraud Detection (Tax Evasion AI)', category: 'Fraud Prevention', savings: 110_000_000, effort: 'High', status: 'identified', priority: 7, timeToValue: 16, confidence: 78 },
];
...
const brReceitaWorkflowSummary = {
  ...
  humanInLoop: 22,
  humanRequired: 14,
  currentLaborSpend: 6_200_000_000,
  potentialSavings: 960_000_000,
};

const brReceitaRoiSummary = {
  techStackSavings: 620_000_000,
  workflowAutomation: 960_000_000,
  licenseRecovery: 420_000_000,
  implementationCosts: 600_000_000,
  netYear1: 1_400_000_000,
  year2Projected: 2_380_000_000,
};
...
const brSusKpis = {
  totalSavings: 1_800_000_000,
  techScoreBefore: 37,
  techScoreAfter: 76,
  workflowsAnalyzed: 82,
  automationReady: 32,
  unusedLicenseWaste: 580_000_000,
  savingsSparkline: [0, 120_000_000, 260_000_000, 420_000_000, 640_000_000, 860_000_000, 1_030_000_000, 1_200_000_000, 1_380_000_000, 1_540_000_000, 1_680_000_000, 1_800_000_000],
  scoreSparkline: [37, 41, 44, 48, 52, 56, 60, 64, 67, 71, 74, 76],
  workflowSparkline: [0, 6, 14, 22, 32, 42, 50, 58, 66, 72, 78, 82],
  licenseSparkline: [580_000_000, 530_000_000, 480_000_000, 430_000_000, 370_000_000, 320_000_000, 260_000_000, 210_000_000, 170_000_000, 140_000_000, 110_000_000, 85_000_000],
...
const brSusTopOpportunities: Opportunity[] = [
  { name: 'DATASUS Health Records AI (215M Patients)', category: 'Health IT', savings: 620_000_000, effort: 'High', status: 'in-progress', priority: 10, timeToValue: 14, confidence: 86 },
  { name: 'SUS Billing & Claims Automation', category: 'Healthcare Finance', savings: 410_000_000, effort: 'Medium', status: 'in-progress', priority: 9, timeToValue: 10, confidence: 88 },
  { name: 'Patient Referral & Bed Management AI', category: 'Healthcare Operations', savings: 260_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 12, confidence: 82 },
  { name: 'Drug Distribution Fraud Detection', category: 'Pharmaceutical', savings: 210_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 8, confidence: 90 },
  { name: 'Epidemiological Surveillance AI', category: 'Public Health', savings: 160_000_000, effort: 'High', status: 'identified', priority: 7, timeToValue: 16, confidence: 76 },
  { name: 'Hospital Resource Optimization (6K Facilities)', category: 'Healthcare Operations', savings: 140_000_000, effort: 'High', status: 'identified', priority: 6, timeToValue: 18, confidence: 74 },
];
...
const brSusWorkflowSummary = {
  ...
  humanInLoop: 30,
  humanRequired: 20,
  currentLaborSpend: 9_600_000_000,
  potentialSavings: 1_240_000_000,
};

const brSusRoiSummary = {
  techStackSavings: 840_000_000,
  workflowAutomation: 1_240_000_000,
  licenseRecovery: 580_000_000,
  implementationCosts: 860_000_000,
  netYear1: 1_800_000_000,
  year2Projected: 3_060_000_000,
};
...
const brBndesKpis = {
  ...
  automationReady: 16,
  unusedLicenseWaste: 320_000_000,
  savingsSparkline: [0, 64_000_000, 140_000_000, 240_000_000, 360_000_000, 480_000_000, 570_000_000, 670_000_000, 760_000_000, 860_000_000, 940_000_000, 1_000_000_000],
  scoreSparkline: [52, 55, 58, 62, 66, 70, 73, 76, 79, 82, 84, 86],
  workflowSparkline: [0, 4, 8, 12, 16, 22, 28, 34, 38, 42, 46, 48],
  licenseSparkline: [320_000_000, 290_000_000, 260_000_000, 230_000_000, 200_000_000, 170_000_000, 140_000_000, 120_000_000, 95_000_000, 75_000_000, 60_000_000, 48_000_000],
...
const brBndesTopOpportunities: Opportunity[] = [
  { name: 'Credit Analysis AI (Loan Evaluation)', category: 'Development Finance', savings: 320_000_000, effort: 'Medium', status: 'in-progress', priority: 10, timeToValue: 8, confidence: 92 },
  { name: 'ESG Compliance Automation', category: 'Compliance', savings: 240_000_000, effort: 'High', status: 'in-progress', priority: 9, timeToValue: 12, confidence: 84 },
  { name: 'Project Monitoring & Disbursement AI', category: 'Operations', savings: 180_000_000, effort: 'Low', status: 'automated', priority: 9, timeToValue: 6, confidence: 94 },
  { name: 'Risk Assessment AI (Portfolio)', category: 'Risk Management', savings: 120_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 14, confidence: 80 },
  { name: 'Development Impact Analytics', category: 'Analytics', savings: 80_000_000, effort: 'Medium', status: 'identified', priority: 7, timeToValue: 10, confidence: 82 },
  { name: 'Infrastructure Project Evaluation AI', category: 'Investment', savings: 60_000_000, effort: 'High', status: 'identified', priority: 6, timeToValue: 18, confidence: 72 },
];
...
const brBndesLicenses: License[] = [
  { vendor: 'Trade Compliance Suite', totalLicenses: 4_800, active90d: 3_200, inactive: 1_600, annualWaste: 146_300_000, action: 'Replace legacy trade compliance with AI-native solution', costPerLicense: 12_000, department: 'Trade & Customs Division', lastAuditDate: '2025-12-15', trend: [74, 70, 66, 64, 62, 67], complianceRisk: true },
  { vendor: 'Microsoft 365 E3', totalLicenses: 28_000, active90d: 23_400, inactive: 4_600, annualWaste: 73_100_000, action: 'Downgrade 4,600 inactive to F1 tier', costPerLicense: 1_200, department: 'All Economic Affairs', lastAuditDate: '2026-02-01', trend: [88, 86, 84, 82, 80, 85], complianceRisk: false },
  { vendor: 'Salesforce Gov Cloud', totalLicenses: 2_400, active90d: 1_800, inactive: 600, annualWaste: 64_000_000, action: 'Consolidate 600 seats — evaluate migration to open-source CRM', costPerLicense: 14_000, department: 'Investment Agency', lastAuditDate: '2026-01-05', trend: [82, 78, 76, 72, 70, 75], complianceRisk: false },
  { vendor: 'Data Analytics Platform', totalLicenses: 1_200, active90d: 840, inactive: 360, annualWaste: 36_600_000, action: 'Migrate to unified analytics on Metabase', costPerLicense: 13_330, department: 'Economic Analysis', lastAuditDate: '2025-11-20', trend: [76, 72, 68, 66, 64, 70], complianceRisk: false },
];
...
const brBndesWorkflowSummary = {
  ...
  humanInLoop: 22,
  humanRequired: 10,
  currentLaborSpend: 4_600_000_000,
  potentialSavings: 680_000_000,
};

const brBndesRoiSummary = {
  techStackSavings: 400_000_000,
  workflowAutomation: 680_000_000,
  licenseRecovery: 320_000_000,
  implementationCosts: 400_000_000,
  netYear1: 1_000_000_000,
  year2Projected: 1_700_000_000,
};
...
const brSerproKpis = {
  totalSavings: 880_000_000,
  techScoreBefore: 54,
  techScoreAfter: 86,
  workflowsAnalyzed: 46,
  automationReady: 18,
  unusedLicenseWaste: 280_000_000,
  savingsSparkline: [0, 55_000_000, 121_000_000, 209_000_000, 319_000_000, 418_000_000, 506_000_000, 594_000_000, 671_000_000, 759_000_000, 825_000_000, 880_000_000],
  scoreSparkline: [54, 58, 61, 64, 67, 70, 73, 76, 79, 82, 84, 86],
  workflowSparkline: [0, 4, 8, 12, 16, 20, 26, 32, 36, 40, 44, 46],
  licenseSparkline: [280_000_000, 250_000_000, 220_000_000, 200_000_000, 170_000_000, 140_000_000, 120_000_000, 100_000_000, 80_000_000, 65_000_000, 52_000_000, 40_000_000],
...
const brSerproTopOpportunities: Opportunity[] = [
  { name: 'Mainframe-to-Cloud Migration AI', category: 'Infrastructure', savings: 286_000_000, effort: 'High', status: 'in-progress', priority: 10, timeToValue: 14, confidence: 82 },
  { name: 'CPF/CNPJ Registry Automation', category: 'Data Processing', savings: 198_000_000, effort: 'Medium', status: 'in-progress', priority: 9, timeToValue: 10, confidence: 88 },
  { name: 'Government Cloud Platform AI', category: 'Cloud Infrastructure', savings: 154_000_000, effort: 'Medium', status: 'identified', priority: 9, timeToValue: 8, confidence: 90 },
  { name: 'Cybersecurity AI (SOC Automation)', category: 'Security', savings: 110_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 12, confidence: 84 },
  { name: 'Data Center Optimization AI', category: 'Infrastructure', savings: 77_000_000, effort: 'High', status: 'identified', priority: 8, timeToValue: 14, confidence: 80 },
  { name: 'API Gateway & Integration Platform', category: 'Platform', savings: 55_000_000, effort: 'Medium', status: 'identified', priority: 7, timeToValue: 16, confidence: 76 },
];
...
const brSerproLicenses: License[] = [
  { vendor: 'Splunk Enterprise', totalLicenses: 1_200, active90d: 880, inactive: 320, annualWaste: 117_900_000, action: 'Consolidate 320 inactive seats, evaluate AI-native SIEM alternatives', costPerLicense: 50_000, department: 'SOC / Threat Detection', lastAuditDate: '2026-01-10', trend: [80, 76, 74, 72, 70, 73], complianceRisk: false },
  { vendor: 'Tenable.io', totalLicenses: 800, active90d: 560, inactive: 240, annualWaste: 70_700_000, action: 'Replace 240 legacy scanner licenses with AI-powered continuous scanning', costPerLicense: 40_000, department: 'Vulnerability Management', lastAuditDate: '2025-12-20', trend: [78, 72, 68, 66, 64, 70], complianceRisk: false },
  { vendor: 'Palo Alto XSOAR', totalLicenses: 600, active90d: 480, inactive: 120, annualWaste: 53_100_000, action: 'Optimize playbook coverage to utilize all 600 licenses effectively', costPerLicense: 60_000, department: 'Incident Response', lastAuditDate: '2026-01-25', trend: [86, 82, 80, 78, 76, 80], complianceRisk: false },
  { vendor: 'CrowdStrike Falcon', totalLicenses: 140_000, active90d: 128_000, inactive: 12_000, annualWaste: 38_300_000, action: 'Reclaim 12,000 seats from decommissioned endpoints', costPerLicense: 430, department: 'All Government Endpoints', lastAuditDate: '2026-02-05', trend: [94, 92, 90, 88, 86, 91], complianceRisk: false },
];
...
const brSerproWorkflowSummary = {
  ...
  humanInLoop: 18,
  humanRequired: 10,
  currentLaborSpend: 6_800_000_000,
  potentialSavings: 540_000_000,
};

const brSerproRoiSummary = {
  techStackSavings: 340_000_000,
  workflowAutomation: 540_000_000,
  licenseRecovery: 280_000_000,
  implementationCosts: 360_000_000,
  netYear1: 880_000_000,
  year2Projected: 1_496_000_000,
};
...
const brInssKpis = {
  totalSavings: 1_120_000_000,
  techScoreBefore: 41,
  techScoreAfter: 78,
  workflowsAnalyzed: 56,
  automationReady: 22,
  unusedLicenseWaste: 360_000_000,
  savingsSparkline: [0, 72_000_000, 154_000_000, 266_000_000, 406_000_000, 532_000_000, 644_000_000, 756_000_000, 854_000_000, 966_000_000, 1_050_000_000, 1_120_000_000],
  scoreSparkline: [41, 45, 48, 52, 56, 60, 63, 66, 70, 73, 76, 78],
  workflowSparkline: [0, 4, 10, 16, 22, 28, 34, 40, 44, 48, 52, 56],
  licenseSparkline: [360_000_000, 328_000_000, 296_000_000, 263_000_000, 228_000_000, 192_000_000, 159_000_000, 128_000_000, 102_000_000, 82_000_000, 64_000_000, 52_000_000],
...
const brInssTopOpportunities: Opportunity[] = [
  { name: 'AI Pension Calculation (38M Beneficiaries)', category: 'Pension Processing', savings: 392_000_000, effort: 'High', status: 'in-progress', priority: 10, timeToValue: 12, confidence: 88 },
  { name: 'Benefit Fraud Detection Engine', category: 'Fraud Prevention', savings: 224_000_000, effort: 'Medium', status: 'in-progress', priority: 9, timeToValue: 10, confidence: 86 },
  { name: 'Disability Claims AI Assessment', category: 'Claims Processing', savings: 168_000_000, effort: 'High', status: 'identified', priority: 8, timeToValue: 14, confidence: 80 },
  { name: 'Citizen Portal AI Assistant', category: 'Citizen Services', savings: 126_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 8, confidence: 84 },
  { name: 'Appeals Processing Automation', category: 'Legal Processing', savings: 112_000_000, effort: 'Medium', status: 'identified', priority: 7, timeToValue: 12, confidence: 78 },
  { name: 'Actuarial Forecasting AI', category: 'Risk Analytics', savings: 98_000_000, effort: 'High', status: 'identified', priority: 6, timeToValue: 16, confidence: 74 },
];

const brInssCurrentStack: CurrentTool[] = [
  { name: 'CNIS Legacy (COBOL)', category: 'Contribution Registry', annualCost: 180_000_000, users: 12_000, score: 3, integrationComplexity: 'High', migrationWeeks: 48, riskLevel: 'High', dependencies: ['Worker Contributions', 'Employment History', 'Benefit Calculation'] },
  { name: 'Meu INSS Portal', category: 'Citizen Services', annualCost: 80_000_000, users: 38_000_000, score: 7, integrationComplexity: 'Low', migrationWeeks: 0, riskLevel: 'Low', dependencies: ['Benefit Applications', 'Status Tracking', 'Document Upload'] },
  { name: 'SABI (Benefit System)', category: 'Benefit Processing', annualCost: 140_000_000, users: 8_000, score: 4, integrationComplexity: 'High', migrationWeeks: 36, riskLevel: 'High', dependencies: ['Pension Payments', 'Disability Benefits', 'Survivor Benefits'] },
  { name: 'Medical Evaluation System', category: 'Disability Assessment', annualCost: 40_000_000, users: 3_200, score: 5, integrationComplexity: 'Medium', migrationWeeks: 16, riskLevel: 'Medium', dependencies: ['Medical Reports', 'Disability Scoring', 'Expert Reviews'] },
  { name: 'PostgreSQL / Oracle Mix', category: 'Database', annualCost: 30_000_000, users: 6_000, score: 5, integrationComplexity: 'Medium', migrationWeeks: 12, riskLevel: 'Medium', dependencies: ['Beneficiary Records', 'Payment History', 'Audit Trails'] },
];

const brInssLicenses: License[] = [
  { vendor: 'CNIS COBOL Mainframe', totalLicenses: 12_000, active90d: 8_000, inactive: 4_000, annualWaste: 120_000_000, action: 'Migrate 4,000 inactive workloads to modern microservices platform', costPerLicense: 30_000, department: 'IT Operations', lastAuditDate: '2026-01-15', trend: [72, 68, 64, 60, 58, 67], complianceRisk: true },
  { vendor: 'Oracle Database (SABI)', totalLicenses: 4_800, active90d: 3_200, inactive: 1_600, annualWaste: 64_000_000, action: 'Migrate 1,600 inactive instances to PostgreSQL', costPerLicense: 40_000, department: 'Benefit Processing', lastAuditDate: '2025-12-20', trend: [74, 68, 64, 60, 58, 67], complianceRisk: true },
  { vendor: 'Microsoft 365 E3', totalLicenses: 36_000, active90d: 28_800, inactive: 7_200, annualWaste: 43_200_000, action: 'Downgrade 7,200 inactive seats to F1 tier', costPerLicense: 1_800, department: 'All INSS Offices', lastAuditDate: '2026-02-01', trend: [86, 82, 80, 78, 76, 80], complianceRisk: false },
  { vendor: 'Medical Evaluation Modules', totalLicenses: 3_200, active90d: 2_000, inactive: 1_200, annualWaste: 36_000_000, action: 'Consolidate 1,200 unused modules, replace with AI assessment tools', costPerLicense: 30_000, department: 'Medical Board', lastAuditDate: '2025-11-10', trend: [68, 62, 58, 54, 52, 62], complianceRisk: false },
  { vendor: 'Document Management System', totalLicenses: 6_000, active90d: 4_200, inactive: 1_800, annualWaste: 16_800_000, action: 'Migrate to unified digital document platform with AI OCR', costPerLicense: 9_330, department: 'Claims Processing', lastAuditDate: '2026-01-20', trend: [76, 72, 70, 68, 66, 70], complianceRisk: false },
];
...
const brInssWorkflowSummary = {
  ...
  humanInLoop: 20,
  humanRequired: 14,
  currentLaborSpend: 7_200_000_000,
  potentialSavings: 728_000_000,
};

const brInssRoiSummary = {
  techStackSavings: 504_000_000,
  workflowAutomation: 728_000_000,
  licenseRecovery: 360_000_000,
  implementationCosts: 472_000_000,
  netYear1: 1_120_000_000,
  year2Projected: 1_904_000_000,
};
...
const brDatasusKpis = {
  totalSavings: 840_000_000,
  techScoreBefore: 43,
  techScoreAfter: 80,
  workflowsAnalyzed: 42,
  automationReady: 16,
  unusedLicenseWaste: 308_000_000,
  savingsSparkline: [0, 53_000_000, 117_000_000, 196_000_000, 308_000_000, 406_000_000, 490_000_000, 560_000_000, 644_000_000, 728_000_000, 784_000_000, 840_000_000],
  scoreSparkline: [43, 47, 50, 54, 58, 62, 66, 69, 72, 75, 78, 80],
  workflowSparkline: [0, 3, 7, 12, 16, 20, 26, 30, 34, 38, 40, 42],
  licenseSparkline: [308_000_000, 280_000_000, 252_000_000, 224_000_000, 196_000_000, 168_000_000, 140_000_000, 112_000_000, 90_000_000, 70_000_000, 56_000_000, 45_000_000],
...
const brDatasusTopOpportunities: Opportunity[] = [
  { name: 'Epidemiological Surveillance AI', category: 'Public Health', savings: 252_000_000, effort: 'High', status: 'in-progress', priority: 10, timeToValue: 14, confidence: 84 },
  { name: 'Health Data Warehouse Modernization', category: 'Data Infrastructure', savings: 196_000_000, effort: 'High', status: 'in-progress', priority: 9, timeToValue: 16, confidence: 80 },
  { name: 'Hospital Performance Analytics', category: 'Healthcare Operations', savings: 140_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 10, confidence: 86 },
  { name: 'Drug Supply Chain Prediction', category: 'Pharmaceutical', savings: 112_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 8, confidence: 88 },
  { name: 'Patient Record Deduplication AI', category: 'Data Quality', savings: 84_000_000, effort: 'Medium', status: 'identified', priority: 7, timeToValue: 12, confidence: 82 },
  { name: 'Automated Health Reporting', category: 'Compliance', savings: 56_000_000, effort: 'Low', status: 'identified', priority: 6, timeToValue: 6, confidence: 90 },
];

const brDatasusCurrentStack: CurrentTool[] = [
  { name: 'SIH/SIA Legacy', category: 'Hospital Information', annualCost: 144_000_000, users: 18_000, score: 4, integrationComplexity: 'High', migrationWeeks: 36, riskLevel: 'High', dependencies: ['Hospital Admissions', 'Outpatient Data', 'SUS Billing'] },
  { name: 'SINAN/SIM/SINASC', category: 'Epidemiological Systems', annualCost: 96_000_000, users: 12_000, score: 5, integrationComplexity: 'High', migrationWeeks: 28, riskLevel: 'High', dependencies: ['Disease Notification', 'Mortality Data', 'Birth Records'] },
  { name: 'CNES Registry', category: 'Facility Registry', annualCost: 48_000_000, users: 8_400, score: 4, integrationComplexity: 'Medium', migrationWeeks: 20, riskLevel: 'Medium', dependencies: ['Health Facility Data', 'Provider Registry', 'Bed Management'] },
  { name: 'e-SUS Atenção Básica', category: 'Primary Care', annualCost: 72_000_000, users: 24_000, score: 6, integrationComplexity: 'Low', migrationWeeks: 8, riskLevel: 'Low', dependencies: ['Primary Care Records', 'Community Health', 'Vaccination Data'] },
  { name: 'Oracle Data Warehouse', category: 'Analytics', annualCost: 60_000_000, users: 4_800, score: 4, integrationComplexity: 'High', migrationWeeks: 24, riskLevel: 'High', dependencies: ['Health Indicators', 'Population Statistics', 'Research Data'] },
];

const brDatasusLicenses: License[] = [
  { vendor: 'Oracle Database Enterprise', totalLicenses: 3_600, active90d: 2_200, inactive: 1_400, annualWaste: 84_000_000, action: 'Migrate 1,400 instances to PostgreSQL — Oracle elimination program', costPerLicense: 60_000, department: 'Data Warehouse', lastAuditDate: '2025-12-15', trend: [70, 64, 60, 56, 54, 61], complianceRisk: true },
  { vendor: 'Legacy Health Modules', totalLicenses: 4_800, active90d: 3_000, inactive: 1_800, annualWaste: 54_000_000, action: 'Decommission 1,800 legacy modules — replace with modern FHIR-based systems', costPerLicense: 30_000, department: 'Health IT', lastAuditDate: '2025-11-01', trend: [66, 60, 56, 52, 50, 62], complianceRisk: true },
  { vendor: 'Microsoft 365 E3', totalLicenses: 24_000, active90d: 19_200, inactive: 4_800, annualWaste: 28_800_000, action: 'Downgrade 4,800 inactive seats to F1 tier', costPerLicense: 1_800, department: 'All DATASUS', lastAuditDate: '2026-02-05', trend: [86, 82, 80, 78, 76, 80], complianceRisk: false },
  { vendor: 'BI Reporting Tools', totalLicenses: 2_400, active90d: 1_600, inactive: 800, annualWaste: 24_000_000, action: 'Migrate 800 seats to open-source Metabase for health analytics', costPerLicense: 30_000, department: 'Epidemiology', lastAuditDate: '2026-01-10', trend: [72, 68, 64, 62, 60, 67], complianceRisk: false },
  { vendor: 'GIS Mapping Software', totalLicenses: 1_200, active90d: 760, inactive: 440, annualWaste: 29_200_000, action: 'Consolidate to open-source QGIS for health geospatial analysis', costPerLicense: 66_360, department: 'Surveillance', lastAuditDate: '2025-12-20', trend: [74, 68, 64, 60, 58, 63], complianceRisk: false },
];
...
const brDatasusWorkflowSummary = {
  ...
  humanInLoop: 16,
  humanRequired: 10,
  currentLaborSpend: 4_800_000_000,
  potentialSavings: 532_000_000,
};

const brDatasusRoiSummary = {
  techStackSavings: 364_000_000,
  workflowAutomation: 532_000_000,
  licenseRecovery: 308_000_000,
  implementationCosts: 364_000_000,
  netYear1: 840_000_000,
  year2Projected: 1_428_000_000,
};
...
const brDefesaKpis = {
  totalSavings: 750_000_000,
  techScoreBefore: 50,
  techScoreAfter: 84,
  workflowsAnalyzed: 34,
  automationReady: 14,
  unusedLicenseWaste: 270_000_000,
  savingsSparkline: [0, 48_000_000, 105_000_000, 180_000_000, 270_000_000, 360_000_000, 435_000_000, 510_000_000, 570_000_000, 645_000_000, 705_000_000, 750_000_000],
  scoreSparkline: [50, 53, 56, 60, 64, 68, 71, 74, 77, 80, 82, 84],
  workflowSparkline: [0, 3, 6, 10, 14, 18, 22, 26, 28, 30, 32, 34],
  licenseSparkline: [270_000_000, 246_000_000, 222_000_000, 195_000_000, 171_000_000, 147_000_000, 123_000_000, 102_000_000, 81_000_000, 63_000_000, 51_000_000, 39_000_000],
...
const brDefesaTopOpportunities: Opportunity[] = [
  { name: 'AI Threat Detection (5M Events/Day)', category: 'Cybersecurity', savings: 240_000_000, effort: 'High', status: 'in-progress', priority: 10, timeToValue: 12, confidence: 86 },
  { name: 'Satellite Imagery AI Analysis', category: 'Intelligence', savings: 180_000_000, effort: 'High', status: 'in-progress', priority: 9, timeToValue: 14, confidence: 82 },
  { name: 'Automated Incident Response', category: 'Cyber Operations', savings: 120_000_000, effort: 'Medium', status: 'identified', priority: 8, timeToValue: 10, confidence: 84 },
  { name: 'Secure Communications AI', category: 'Communications', savings: 90_000_000, effort: 'High', status: 'identified', priority: 8, timeToValue: 16, confidence: 76 },
  { name: 'Intelligence Fusion Platform', category: 'Intelligence', savings: 75_000_000, effort: 'High', status: 'identified', priority: 7, timeToValue: 18, confidence: 72 },
  { name: 'Vulnerability Management AI', category: 'Security', savings: 45_000_000, effort: 'Medium', status: 'identified', priority: 6, timeToValue: 8, confidence: 88 },
];

const brDefesaCurrentStack: CurrentTool[] = [
  { name: 'Defense SIEM (Splunk)', category: 'Security Monitoring', annualCost: 96_000_000, users: 4_800, score: 7, integrationComplexity: 'Medium', migrationWeeks: 8, riskLevel: 'Medium', dependencies: ['Log Aggregation', 'Threat Detection', 'Compliance Monitoring'] },
  { name: 'Satellite Ground Station', category: 'Imagery Intelligence', annualCost: 144_000_000, users: 12_000, score: 6, integrationComplexity: 'High', migrationWeeks: 24, riskLevel: 'High', dependencies: ['Satellite Imagery', 'Change Detection', 'Geospatial Analysis'] },
  { name: 'C4ISR Legacy Systems', category: 'Command & Control', annualCost: 168_000_000, users: 22_000, score: 4, integrationComplexity: 'High', migrationWeeks: 48, riskLevel: 'High', dependencies: ['Command Systems', 'Tactical Networks', 'Situational Awareness'] },
  { name: 'Secure Comms Platform', category: 'Communications', annualCost: 108_000_000, users: 22_000, score: 6, integrationComplexity: 'High', migrationWeeks: 20, riskLevel: 'High', dependencies: ['Encrypted Voice', 'Secure Messaging', 'Data Links'] },
];

const brDefesaLicenses: License[] = [
  { vendor: 'Splunk Enterprise Security', totalLicenses: 4_800, active90d: 3_600, inactive: 1_200, annualWaste: 90_000_000, action: 'Consolidate 1,200 inactive seats, optimize log ingestion tiers', costPerLicense: 50_000, department: 'Cyber Command SOC', lastAuditDate: '2026-01-10', trend: [80, 76, 74, 72, 70, 75], complianceRisk: false },
  { vendor: 'Satellite Processing Suite', totalLicenses: 1_200, active90d: 840, inactive: 360, annualWaste: 64_800_000, action: 'Replace 360 legacy licenses with AI-native imagery processing', costPerLicense: 120_000, department: 'Imagery Intelligence', lastAuditDate: '2025-12-15', trend: [76, 70, 66, 64, 62, 70], complianceRisk: false },
  { vendor: 'C4ISR Legacy Modules', totalLicenses: 2_400, active90d: 1_600, inactive: 800, annualWaste: 72_000_000, action: 'Decommission 800 legacy C4ISR modules as modernization proceeds', costPerLicense: 60_000, department: 'Joint Operations', lastAuditDate: '2025-11-20', trend: [72, 66, 62, 58, 56, 67], complianceRisk: true },
  { vendor: 'CrowdStrike Falcon (Defense)', totalLicenses: 80_000, active90d: 72_000, inactive: 8_000, annualWaste: 28_800_000, action: 'Reclaim 8,000 seats from decommissioned endpoints', costPerLicense: 3_600, department: 'All Defense Endpoints', lastAuditDate: '2026-02-01', trend: [92, 90, 88, 86, 84, 90], complianceRisk: false },
];
...
const brDefesaWorkflowSummary = {
  ...
  humanInLoop: 12,
  humanRequired: 8,
  currentLaborSpend: 5_800_000_000,
  potentialSavings: 480_000_000,
};

const brDefesaRoiSummary = {
  techStackSavings: 330_000_000,
  workflowAutomation: 480_000_000,
  licenseRecovery: 270_000_000,
  implementationCosts: 330_000_000,
  netYear1: 750_000_000,
  year2Projected: 1_275_000_000,
};
...
const brAnatelKpis = {
  totalSavings: 480_000_000,
  techScoreBefore: 46,
  techScoreAfter: 82,
  workflowsAnalyzed: 28,
  automationReady: 10,
  unusedLicenseWaste: 192_000_000,
  savingsSparkline: [0, 32_000_000, 67_000_000, 112_000_000, 176_000_000, 224_000_000, 272_000_000, 320_000_000, 368_000_000, 416_000_000, 448_000_000, 480_000_000],
  scoreSparkline: [46, 49, 52, 56, 60, 64, 68, 72, 75, 78, 80, 82],
  workflowSparkline: [0, 2, 5, 8, 10, 14, 18, 20, 22, 24, 26, 28],
  licenseSparkline: [192_000_000, 176_000_000, 157_000_000, 138_000_000, 118_000_000, 102_000_000, 86_000_000, 70_000_000, 58_000_000, 45_000_000, 35_000_000, 29_000_000],
...
const brAnatelTopOpportunities: Opportunity[] = [
  { name: 'Spectrum Monitoring AI (40K Points)', category: 'Spectrum Management', savings: 144_000_000, effort: 'Medium', status: 'in-progress', priority: 10, timeToValue: 10, confidence: 88 },
  { name: 'Telecom Compliance Automation', category: 'Regulatory', savings: 112_000_000, effort: 'Medium', status: 'in-progress', priority: 9, timeToValue: 8, confidence: 86 },
  { name: '5G Coverage Planning AI', category: 'Infrastructure', savings: 80_000_000, effort: 'High', status: 'identified', priority: 8, timeToValue: 14, confidence: 80 },
  { name: 'Consumer Complaint AI Routing', category: 'Consumer Services', savings: 64_000_000, effort: 'Low', status: 'identified', priority: 8, timeToValue: 6, confidence: 90 },
  { name: 'License Processing Automation', category: 'Licensing', savings: 48_000_000, effort: 'Medium', status: 'identified', priority: 7, timeToValue: 10, confidence: 84 },
  { name: 'Spectrum Auction Analytics', category: 'Economics', savings: 32_000_000, effort: 'High', status: 'identified', priority: 6, timeToValue: 16, confidence: 76 },
];

const brAnatelCurrentStack: CurrentTool[] = [
  { name: 'Spectrum Monitoring System', category: 'RF Monitoring', annualCost: 96_000_000, users: 4_800, score: 7, integrationComplexity: 'Low', migrationWeeks: 0, riskLevel: 'Low', dependencies: ['RF Measurement', 'Interference Detection', 'Signal Analysis'] },
  { name: 'Licensing Platform (Legacy)', category: 'License Management', annualCost: 72_000_000, users: 8_000, score: 4, integrationComplexity: 'High', migrationWeeks: 28, riskLevel: 'High', dependencies: ['License Applications', 'Renewal Processing', 'Fee Collection'] },
  { name: 'QoS Monitoring Platform', category: 'Quality of Service', annualCost: 48_000_000, users: 3_600, score: 6, integrationComplexity: 'Medium', migrationWeeks: 12, riskLevel: 'Medium', dependencies: ['Service Quality Metrics', 'Coverage Maps', 'Operator Benchmarks'] },
  { name: 'Consumer Complaint System', category: 'Consumer Relations', annualCost: 28_800_000, users: 6_400, score: 5, integrationComplexity: 'Medium', migrationWeeks: 16, riskLevel: 'Medium', dependencies: ['Complaint Intake', 'Case Tracking', 'Resolution Management'] },
  { name: 'PostgreSQL', category: 'Database', annualCost: 14_000_000, users: 1_600, score: 7, integrationComplexity: 'Low', migrationWeeks: 4, riskLevel: 'Low', dependencies: ['Regulatory Data', 'Spectrum Records', 'Compliance History'] },
];

const brAnatelLicenses: License[] = [
  { vendor: 'Legacy Licensing Platform', totalLicenses: 4_000, active90d: 2_800, inactive: 1_200, annualWaste: 57_600_000, action: 'Replace legacy licensing with modern AI-native regulatory platform', costPerLicense: 48_000, department: 'Licensing Division', lastAuditDate: '2025-12-15', trend: [76, 70, 66, 64, 62, 70], complianceRisk: true },
  { vendor: 'Spectrum Analysis Software', totalLicenses: 2_400, active90d: 1_800, inactive: 600, annualWaste: 48_000_000, action: 'Consolidate 600 seats — migrate to AI-integrated spectrum tools', costPerLicense: 80_000, department: 'Spectrum Management', lastAuditDate: '2026-01-10', trend: [80, 76, 74, 72, 70, 75], complianceRisk: false },
  { vendor: 'Microsoft 365 E3', totalLicenses: 18_000, active90d: 14_400, inactive: 3_600, annualWaste: 34_560_000, action: 'Downgrade 3,600 inactive seats to F1 tier', costPerLicense: 9_600, department: 'All ANATEL', lastAuditDate: '2026-02-01', trend: [86, 82, 80, 78, 76, 80], complianceRisk: false },
  { vendor: 'GIS & Coverage Tools', totalLicenses: 1_800, active90d: 1_200, inactive: 600, annualWaste: 28_800_000, action: 'Migrate 600 seats to open-source QGIS with AI extensions', costPerLicense: 48_000, department: 'Coverage Planning', lastAuditDate: '2025-11-20', trend: [74, 70, 66, 64, 62, 67], complianceRisk: false },
  { vendor: 'Data Analytics Platform', totalLicenses: 1_200, active90d: 840, inactive: 360, annualWaste: 23_040_000, action: 'Consolidate to unified analytics on Metabase', costPerLicense: 64_000, department: 'Market Analysis', lastAuditDate: '2026-01-20', trend: [76, 72, 68, 66, 64, 70], complianceRisk: false },
];
...
const brAnatelWorkflowSummary = {
  ...
  humanInLoop: 12,
  humanRequired: 6,
  currentLaborSpend: 3_200_000_000,
  potentialSavings: 288_000_000,
};

const brAnatelRoiSummary = {
  techStackSavings: 192_000_000,
  workflowAutomation: 288_000_000,
  licenseRecovery: 192_000_000,
  implementationCosts: 192_000_000,
  netYear1: 480_000_000,
  year2Projected: 816_000_000,
};
...
const brazilWorkflows: Workflow[] = [
  {
    ...
    costShift: 'Labor $54M → IT $12M + Labor $18M = $24M saved',
    savings: 24_000_000,
    automationPercent: 78,
  ...
  },
  {
    ...
    costShift: 'Labor $36M → IT $8M + Labor $16M = $12M saved',
    savings: 12_000_000,
    automationPercent: 48,
  ...
  },
  {
    ...
    level: 'full',
    currentFTEs: 2_500,
    currentCost: 30_000_000,
    volume: '35M+ personal + 8M corporate tax filings/year',
    ...
    costShift: 'Labor $30M → IT $7M + Labor $10M = $13M saved',
    savings: 13_000_000,
    automationPercent: 85,
  ...
  },
  {
    ...
    level: 'human-in-loop',
    currentFTEs: 2_000,
    currentCost: 24_000_000,
    volume: '12M benefit applications/year',
    ...
    costShift: 'Labor $24M → IT $5.6M + Labor $10M = $8.4M saved',
    savings: 8_400_000,
    automationPercent: 52,
  ...
  },
  {
    ...
    currentFTEs: 1_200,
    currentCost: 14_400_000,
    volume: '2.8M new registrations + 12M compliance filings/year',
    ...
    costShift: 'Labor $14.4M → IT $3.2M + Labor $4.8M = $6.4M saved',
    savings: 6_400_000,
    automationPercent: 82,
  ...
  },
  {
    ...
    level: 'full',
    currentFTEs: 1_800,
    currentCost: 21_600_000,
    volume: '120,000 tenders/year, $42B total procurement value',
