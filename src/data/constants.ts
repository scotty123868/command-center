...
export const workflows: Workflow[] = [
  ...
  },
  {
    ...
    details: '10 estimators producing bids for railroad construction, maintenance, and testing contracts. $800M/yr in revenue depends on competitive, accurate bidding.',
    currentProcess: [
...
export const transformationStories: TransformationStory[] = [
  {
    ...
    company: 'Heavy/highway & railroad contractor, $800M revenue, 7 divisions, 800+ vehicles',
    revenue: '$800M',
  ...
  {
    id: 'license-waste',
    title: 'The $800M Company Bleeding $2.8M in Unused Software',
