...
const divisionsByCompany: Record<string, CompanyData[]> = {
  ...
  brazil: [
    ...
    },
    {
      ...
      industry: 'Social Security & Pensions',
      employees: 36000,
      aiScoreBefore: 42,
      aiScoreAfter: 78,
      totalSavings: '$8.0M/yr',
      metrics: [
        { label: 'Pension Processing', value: '-72%', trend: -72, trendPositive: true, sparkline: [45, 38, 32, 27, 22, 16, 12.6] },
        { label: 'Fraud Detection', value: '92%', trend: 34, trendPositive: true, sparkline: [62, 68, 74, 80, 85, 89, 92] },
        { label: 'Citizen Satisfaction', value: '86%', trend: 20, trendPositive: true, sparkline: [70, 73, 76, 79, 82, 84, 86] },
        { label: 'Disability Claims', value: '-45%', trend: -45, trendPositive: true, sparkline: [90, 78, 68, 60, 55, 52, 49.5] },
        { label: 'Self-Service Rate', value: '68%', trend: 36, trendPositive: true, sparkline: [36, 40, 46, 52, 58, 64, 68] },
        { label: 'Appeals Backlog', value: '-52%', trend: -52, trendPositive: true, sparkline: [800, 680, 580, 500, 440, 400, 384] },
      ],
      savings: [
        { category: 'Pension Automation', amount: 2800 },
        { category: 'Fraud Prevention', amount: 2400 },
        { category: 'Claims Processing', amount: 1600 },
        { category: 'Citizen Services', amount: 1200 },
      ],
      beforeAfter: [
        { label: 'Pension Processing', before: '45 days', after: '12.6 days' },
        { label: 'Fraud Detection Rate', before: '62%', after: '92%' },
        { label: 'Self-Service Adoption', before: '36%', after: '68%' },
        { label: 'Appeals Processing', before: '800K backlog', after: '384K backlog' },
      ],
      automations: [
        { name: 'AI Pension Calculator', status: 'live', department: 'Benefits' },
        { name: 'Benefit Fraud Detector', status: 'live', department: 'Fraud Prevention' },
        { name: 'Disability Assessment AI', status: 'piloting', department: 'Medical Board' },
        { name: 'Citizen AI Assistant', status: 'planned', department: 'Meu INSS' },
      ],
    },
    {
      name: 'DATASUS — Health Informatics',
      industry: 'Health IT & Epidemiology',
      employees: 24000,
      aiScoreBefore: 44,
      aiScoreAfter: 80,
      totalSavings: '$6.0M/yr',
      metrics: [
        { label: 'Outbreak Detection', value: '-79%', trend: -79, trendPositive: true, sparkline: [14, 11, 8, 6, 4.5, 3.5, 2.9] },
        { label: 'Data Quality Score', value: '94%', trend: 28, trendPositive: true, sparkline: [70, 74, 78, 82, 86, 90, 94] },
        { label: 'Hospital Reporting', value: '+55%', trend: 55, trendPositive: true, sparkline: [60, 66, 72, 78, 84, 90, 93] },
        { label: 'Patient Matching', value: '96%', trend: 18, trendPositive: true, sparkline: [82, 84, 87, 90, 92, 94, 96] },
        { label: 'Drug Supply Accuracy', value: '91%', trend: 22, trendPositive: true, sparkline: [72, 76, 80, 84, 87, 89, 91] },
        { label: 'FHIR Adoption', value: '60%', trend: 48, trendPositive: true, sparkline: [14, 22, 30, 38, 46, 54, 60] },
      ],
      savings: [
        { category: 'Surveillance AI', amount: 1800 },
        { category: 'Data Infrastructure', amount: 1400 },
        { category: 'Hospital Analytics', amount: 1600 },
        { category: 'Supply Chain AI', amount: 1200 },
      ],
      beforeAfter: [
        { label: 'Outbreak Detection', before: '14 days', after: '2.9 days' },
        { label: 'Data Quality Score', before: '70%', after: '94%' },
        { label: 'Patient Record Matching', before: '82%', after: '96%' },
        { label: 'FHIR Adoption', before: '14%', after: '60%' },
      ],
      automations: [
        { name: 'Outbreak Detection AI', status: 'live', department: 'Epidemiology' },
        { name: 'Data Quality Engine', status: 'live', department: 'Data Governance' },
        { name: 'Hospital Performance AI', status: 'piloting', department: 'Healthcare Analytics' },
        { name: 'Drug Supply Predictor', status: 'planned', department: 'Pharmaceutical' },
      ],
    },
    {
      ...
      metrics: [
        { label: 'Threat Detection', value: '-96%', trend: -96, trendPositive: true, sparkline: [360, 240, 160, 80, 40, 20, 15] },
        { label: 'Satellite Analysis', value: '8x', trend: 700, trendPositive: true, sparkline: [1, 2, 3, 4, 5.5, 7, 8] },
        { label: 'Incident Response', value: '-88%', trend: -88, trendPositive: true, sparkline: [240, 180, 120, 80, 50, 35, 30] },
        { label: 'False Positive Rate', value: '-72%', trend: -72, trendPositive: true, sparkline: [28, 22, 18, 14, 10, 8.5, 7.8] },
        { label: 'Intel Processing', value: '-65%', trend: -65, trendPositive: true, sparkline: [48, 40, 32, 26, 22, 18, 16.8] },
        { label: 'Cyber Readiness', value: '84', trend: 34, trendPositive: true, sparkline: [50, 56, 62, 68, 74, 80, 84] },
      ],
      savings: [
        { category: 'Threat Detection AI', amount: 1600 },
        { category: 'Satellite Imagery AI', amount: 1200 },
        { category: 'Incident Response', amount: 1200 },
        { category: 'Intel Fusion', amount: 1000 },
      ],
      beforeAfter: [
        { label: 'Mean Time to Detect', before: '6 hours', after: '15 min' },
        { label: 'Satellite Analysis', before: '1x throughput', after: '8x throughput' },
        { label: 'Incident Response', before: '4 hours', after: '30 min' },
        { label: 'False Positive Rate', before: '28%', after: '7.8%' },
      ],
      automations: [
        { name: 'AI Threat Hunter', status: 'live', department: 'SOC' },
        { name: 'Satellite Imagery AI', status: 'live', department: 'Intelligence' },
        { name: 'Automated Incident Response', status: 'piloting', department: 'Cyber Ops' },
        { name: 'Intelligence Fusion AI', status: 'planned', department: 'Joint Intelligence' },
      ],
    },
    {
      ...
      aiScoreBefore: 46,
      aiScoreAfter: 82,
      totalSavings: '$3.0M/yr',
      metrics: [
        { label: 'Interference Detection', value: '-94%', trend: -94, trendPositive: true, sparkline: [72, 52, 36, 22, 14, 6, 4.3] },
        { label: 'License Processing', value: '3x', trend: 200, trendPositive: true, sparkline: [1, 1.4, 1.8, 2.2, 2.5, 2.8, 3.0] },
        { label: 'Compliance Efficiency', value: '+40%', trend: 40, trendPositive: true, sparkline: [60, 66, 72, 76, 80, 84, 84] },
        { label: 'Complaint Resolution', value: '-55%', trend: -55, trendPositive: true, sparkline: [30, 26, 22, 18, 16, 14, 13.5] },
        { label: '5G Planning Accuracy', value: '92%', trend: 26, trendPositive: true, sparkline: [70, 74, 78, 82, 86, 90, 92] },
        { label: 'Spectrum Utilization', value: '+18%', trend: 18, trendPositive: true, sparkline: [72, 74, 76, 79, 82, 86, 85] },
      ],
      savings: [
        { category: 'Spectrum AI', amount: 900 },
        { category: 'Compliance Automation', amount: 700 },
        { category: '5G Planning AI', amount: 700 },
        { category: 'Consumer Services', amount: 700 },
      ],
      beforeAfter: [
        { label: 'Interference Detection', before: '72 hours', after: '4.3 hours' },
        { label: 'License Processing', before: '1x speed', after: '3x speed' },
        { label: 'Complaint Resolution', before: '30 days', after: '13.5 days' },
        { label: '5G Planning Accuracy', before: '70%', after: '92%' },
      ],
      automations: [
        { name: 'Spectrum Monitor AI', status: 'live', department: 'RF Management' },
        { name: 'Compliance Scorer', status: 'live', department: 'Regulatory' },
        { name: '5G Coverage Planner', status: 'piloting', department: 'Infrastructure' },
        { name: 'Auction Analytics AI', status: 'planned', department: 'Spectrum Economics' },
      ],
    },
  ],
};
...
const companyToDivIndex: Record<string, { parent: string; index: number }> = {
  ...
  'br-inss': { parent: 'brazil', index: 4 },
  'br-datasus': { parent: 'brazil', index: 5 },
  'br-defesa': { parent: 'brazil', index: 6 },
  'br-anatel': { parent: 'brazil', index: 7 },
};
